...
// Output format :
// The first line of output prints "Please Gpay Rs." followed by a double value representing the total expenditure value.

// The second line of output prints "Thanks, Visit us again!".
...
public class Main {    
    public static void main(String[] args) {       
        ...
        System.out.println("Please Gpay Rs." + expenditure);     
