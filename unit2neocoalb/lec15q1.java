...
// Output format :
// The first line of output prints "Discounted Price: Rs. <discounted_price>" where <discounted_price> is the base price after applying the discount, rounded to two decimal places.

// The second line of output prints "Amount Saved: Rs. <amount_saved>" where <amount_saved> is the amount reduced due to the discount, rounded to two decimal places.
